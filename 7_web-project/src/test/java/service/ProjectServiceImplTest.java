...
public class ProjectServiceImplTest {
    ...
    public void readByEmail() throws SQLException, NotFoundException {
        ...
        Project expected = new Project(0, "Test project", 0, testEmail, "11111111");
    ...
    public void createAndUpdateAndDeleteTest() throws SQLException, AlreadyExistException, NotFoundException {
        ...
        Project testProject = new Project(createId, "Test_CREATE_project", 0000, "test_CREATE@yahho.com", "1212tcp");
        ...
        Project current = new Project(createId, "Test_UPDATE_project", 0000, "test_UPDATE@yahho.com", "1212tcp");
