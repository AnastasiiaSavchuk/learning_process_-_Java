...
public class WorkerServiceImplTest {
    ...
    public void readByData() throws SQLException {
        String testFullName = "Test Worker";
        Worker expected = new Worker(0, testFullName,"title",0);
        Worker actual = workerService.readByData(testFullName);
