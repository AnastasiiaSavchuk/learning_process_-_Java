...
public class TeamLeadServiceImplTest {
    ...
    public void createAndUpdateAndDeleteTest() throws SQLException, AlreadyExistException, NotFoundException {
        ...
        Project testProject = new Project(createId, "Test_CREATE_project", "client", 0, "test_CREATE@yahho.com", "1212tcp");
        ...
        TeamLead current = new TeamLead(createId, "Test_UPDATE_team_lead_name", "1989-10-02", 0);
        teamLeadService.update(createId, current);
        Assertions.assertEquals(current, teamLeadService.readById(createId));
